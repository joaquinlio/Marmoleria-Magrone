    ...
    <thead class="thead-light">
        <tr>
            <th class="text-center" scope="col" colspan="4">
                <h2>{{ $title }}</h2>
                <form action="{{ route('productos.buscador') }}" method="GET" class="form-inline">
                    <div class="form-group">
                        <input type="text" name="buscadorPro" id="buscadorPro" class="form-control" placeholder="Buscar Producto" autocomplete="off">
                    </div>
                    <div class="form-group">
