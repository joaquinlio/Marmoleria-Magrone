@php
    ...
    $totalPed = number_format($pedido->totalPed,2,",",".");
    $dias = array("Domingo","Lunes","Martes","Miercoles","Jueves","Viernes","Sábado");
    $meses = array("Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre");
    $time = strtotime($pedido->fecha);
...
<html lang="en">
  ...
  <body> 
    ...
    <div id="numero">
        <input type="text" class="form-control" style=" width: 80px;  font-weight: bold;" value="{{ $pedido->pdo_id}}">    
    </div>
    <hr> 
    ...
    <div id="canaldeventa">
        <input type="text" class="form-control" value="{{ $pedido->canaldeventa }}">
    </div>
    ...
    <table class="table table-sm table-bordered ">
        ...
        <table id="opciones" class="table table-sm table-bordered">
                ...
                <tr>
                <th>Seña:</th>
                <td>$@php echo number_format($pedido->senia,2,",",".");@endphp</td>
                </tr>
                <tr>
                <th>Descuento:</th>
                ...
                <td>$@php echo number_format($pedido->saldo,2,",",".");@endphp</td>
                </tr>
        </table>
